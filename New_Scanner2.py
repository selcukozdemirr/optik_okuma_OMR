...
# Görüntü yolu
image_path = 'C:/Users/Selcuk.Ozdemir/PycharmProjects/pythonProject/taramalar/tarama_Sayfa_8.jpg'
...
# Öğrenci numarası ve cevapları bir DataFrame'e dönüştürün
df = pd.DataFrame([answers])
df.insert(0, 'Öğrenci Numarası', ''.join(student_number))

# Excel dosyasına kaydedin
excel_filename = 'optik_form_sonuclari.xlsx'
